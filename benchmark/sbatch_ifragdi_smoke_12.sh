#!/usr/bin/env bash
#SBATCH --job-name=ifragdi_smoke12
#SBATCH --partition=normal
#SBATCH --cpus-per-task=4
#SBATCH --mem=24G
#SBATCH --time=12:00:00
#SBATCH --output=benchmark/logs/slurm/ifragdi_smoke12_%j.out
#SBATCH --error=benchmark/logs/slurm/ifragdi_smoke12_%j.err
...
echo "=== Running 12-case smoke set ==="
